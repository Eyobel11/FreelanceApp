      ...
      <div className="container mx-auto px-6 md:px-16 lg:px-40 py-10">
        ...
        >
          ...
          >
                ...
                <img
                  // src={sampleImage}
                  src={freelancer.profileImage? `http://localhost:5000${freelancer.profileImage}` : "https://via.placeholder.com/150"}
                  alt="img"
                  className="w-full h-56 object-cover object-center rounded-t-lg mb-2"
                />
