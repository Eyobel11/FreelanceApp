...
import sampleImage from '../assets/find.jpg';
    ...
    <section className="bg-white py-16 px-6 md:px-12 lg:px-32">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 w-full lg:pr-16 pr-0 text-center lg:text-left ml-12">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold mb-4 animate-fade-in">Find great work</h1>
          ...
          <button onClick={clickaway} className="flex items-center px-6 py-3 border-2 border-black text-black font-medium rounded-full hover:bg-black hover:text-white transition-all animate-fade-in">
